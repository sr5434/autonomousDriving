"""Test model.
Based on this script: https://github.com/Zhenye-Na/e2e-learning-self-driving-cars/blob/master/src/drive.py"""
...
transformations = Lambda(custom_transformation)
...
def telemetry(sid, data):
    ...
    if data:
        ...
        image_tensor = tf.reshape(image_tensor, [1, 3, 70, 320])

        output_tensor = model(image_tensor)
        #print(output_tensor)
        steering_angle = output_tensor[0]
